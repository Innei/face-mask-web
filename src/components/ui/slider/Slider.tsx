...
export const Slider = ({
  ...
  >
    ...
    <SliderPrimitive.Thumb
      className={clsxm(
        'bg-accent block size-4 rounded-full border shadow transition-colors focus-visible:outline-none focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50',
        variant === 'primary'
